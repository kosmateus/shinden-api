...
/**
 * Enumeration representing different character types for tagging purposes in the application.
 *
 * <p>Each character type is associated with a unique identifier and a translation key for localization
...
public enum CharacterType implements Tag {
    ...
    BISHOUJO(576, "tags.character-type.bishoujo"),
    BISHONEN(1723, "tags.character-type.bishonen"),
    TWINS(2957, "tags.character-type.twins"),
    ...
    CYBORGS(1726, "tags.character-type.cyborgs"),
    ...
    DETECTIVES(256, "tags.character-type.detectives"),
    DOCTORS(2217, "tags.character-type.doctors"),
    ADULTS(1760, "tags.character-type.adults"),
    GHOSTS(1731, "tags.character-type.ghosts"),
    KIDS(1737, "tags.character-type.kids"),
    ...
    IDOLS(352, "tags.character-type.idols"),
    YOUNGER_SISTERS(1787, "tags.character-type.younger-sisters"),
    ...
    ALIENS(421, "tags.character-type.aliens"),
    CATS(594, "tags.character-type.cats"),
    DWARVES(2864, "tags.character-type.dwarves"),
    BUTLERS(1232, "tags.character-type.butlers"),
    ...
    MURDERERS(1902, "tags.character-type.murderers"),
    ...
    STUDENTS(1875, "tags.character-type.students"),
    SUCCUBI(2839, "tags.character-type.succubi"),
    SUPERHEROES(2369, "tags.character-type.superheroes"),
    MERMAIDS(496, "tags.character-type.mermaids"),
    SKELETONS(2949, "tags.character-type.skeletons"),
    SPIES(2181, "tags.character-type.spies"),
    ...
    PUPILS(1819, "tags.character-type.pupils"),
    VILLAINESS(2977, "tags.character-type.villainess"),
    VAMPIRES(83, "tags.character-type.vampires"),
    WITCHES(1728, "tags.character-type.witches"),
    WEREWOLVES(2044, "tags.character-type.werewolves"),
    FAIRIES(387, "tags.character-type.fairies"),
    DEMON_LORD(2383, "tags.character-type.demon-lord"),
    ...
    private final String tagType = "entity";
